...
public final class DBPerson {
	public static boolean saveMe(User person) {
		...
		if (person.getPassword() instanceof String)
		...
		if (person.getFirst_name() instanceof String)
			found.setFirst_name(person.getFirst_name());
		if (person.getLast_name() instanceof String)
			found.setLast_name(person.getLast_name());
		if (person.getPhone() instanceof String)
			found.setPhone(person.getPhone());
		if (person.getUrl() instanceof String)
			found.setUrl(person.getUrl());
		if (person.getHref() instanceof String)
			found.setHref(person.getHref());
		db.store(found);
		db.commit();
		return true;
	}

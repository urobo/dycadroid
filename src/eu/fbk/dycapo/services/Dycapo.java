...
public final class Dycapo {
	...
	"dycapo.acceptRide", // dycapo.accept_ride_request ( Trip trip , Person
							// person )
			"dycapo.insertTrip", // dycapo.add_trip ( Trip trip , Mode mode ,
									// Prefs preferences , Location source ,
									// Location destination )
			"dycapo.cancelRide", // dycapo.cancel_requested_ride ( Trip trip )
			"dycapo.changePassword", // dycapo.change_password ( Person person )

			"dycapo.statusRequestedRide", // dycapo.check_requested_ride ( Trip
											// trip )
			...
			"dycapo.refuseRide", // dycapo.refuse_ride_request ( Trip trip ,
									// Person person )
			"dycapo.register", // dycapo.register ( Person person )
			"dycapo.requestRide", // dycapo.request_ride ( Trip trip )
			"dycapo.searchRide", // dycapo.search_trip ( Location source ,
									// Location destination )
	...
	public static String getMethod(int method) {
		if (method >= 0 && method < Dycapo.DYCAPO_METHODS.length)
			return Dycapo.DYCAPO_METHODS[method];
		return null;
	}
}

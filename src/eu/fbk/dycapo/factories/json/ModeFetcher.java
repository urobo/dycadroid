		...
		try {
			...
			if (responseValue.has(Mode.CAPACITY))
				...
				throw new DycapoException(
						"error ModeFetcher.fetchMode : Mode.CAPACITY is compulsory");
			...
			if (responseValue.has(Mode.KIND))
				...
				throw new DycapoException(
						"error ModeFetcher.fetchMode : Mode.KIND is compulsory");
